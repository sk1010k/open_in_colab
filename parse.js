 ...
 */
async function extractBranchName() {
    ...
    const results = await chrome.scripting.executeScript({
        ...
        func: () => {
            // GitHubのブランチ名を取得する例
            const button = document.getElementById('branch-picker-repos-header-ref-selector');
...
const GITHUB_GIST_RE = /^https?:\/\/gist\.github\.com\/(.+)\/([a-f0-9]+(?:\#file\-.*\-ipynb)?)$/;
/**
 ...
 * otherwise null.
 */
export async function githubToColabUrl(githubUrl) {
